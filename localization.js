            ...
            localization =
             {
                 ...
                 days: {
                     ...
                     // abbreviated day names
                     namesAbbr: ["Воск", "Пон", "Втор", "Сред", "Четв", "Пят", "Субб"],
                     // shortest day names
                 ...
                 pagershowrowsstring: "Кол-во строк",
                 pagerrangestring: " из ",
                 pagerpreviousbuttonstring: "пред",
                 pagernextbuttonstring: "след",
                 pagerfirstbuttonstring: "перв",
                 pagerlastbuttonstring: "посл",
                 groupsheaderstring: "Перетащите поле сюда для группировки по колонке",
                 sortascendingstring: "По возрастанию",
                 sortdescendingstring: "По убыванию",
                 sortremovestring: "Без сортировки",
                 groupbystring: "Сгруппировать по колонке",
                 groupremovestring: "Убрать групировку",
                 filterclearstring: "Без фильтра",
                 filterstring: "Фильтр",
                 ...
                 filterstringcomparisonoperators: ['пусто', 'не пусто', 'содержит', 'содержит(регистр)',
                   'не содержит', 'не содержит(регистр)', 'начинается с', 'начинается с(регистр)',
                   'заканчивается', 'заканчивается(регистр)', 'равно', 'равно(регистр)', 'не заполнено', 'заполнено'],
                 filternumericcomparisonoperators: ['равно', 'не равно', 'меньше чем', 'меньше либо равно', 'больше чем', 'больше чем или равно', 'не заполнено', 'заполнено'],
                 filterdatecomparisonoperators: ['равно', 'не равно', 'меньше чем', 'меньше либо равно', 'больше чем', 'больше либо равно', 'не заполнено', 'заполнено'],
                 filterbooleancomparisonoperators: ['равно', 'не равно'],
                 validationstring: "Проверьте введенное значение",
