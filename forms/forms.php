...
var formButtons = [
				...
				{name:'editsource', label:'Edit Source Code', onClick: function(){
								...
								var result = rcf('utils','getformcontent',[maindata.formState.rowdata.name]);
								var editor;
								dialog({
								...
								message:'<div><button id="SaveSourceCodeButton" style="margin-left:1%">Save</button><div><div><textarea id="xeditor" style="margin-top:1%;visibility:hidden;width:100%;height:90%;white-space: pre;"></textarea></div>', 
								 beforeOpen: function(){
									 ...
									 $("#SaveSourceCodeButton").on('click', function(){var result = rcf('utils','setformcontent',[maindata.formState.rowdata.name,editor.getValue()]);});
								...
								success:function(){
									 ...
									 var result = rcf('utils','setformcontent',[maindata.formState.rowdata.name,editor.getValue()]); 
